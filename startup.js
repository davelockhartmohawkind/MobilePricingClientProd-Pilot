...
$(document).ready(function () {
    ...
    var handleExists = function (exists) {
        ...
        if (exists) {
            ...
            // var ref = window.open('http://mobilepricing-pilot.mohawkind.com', '_self', 'toolbar=no,location=no');
            //window.plugins.ChildBrowser.showWebPage('http://mobilepricing-pilot.mohawkind.com',
            //                        {
    ...
    myInterval = setInterval(function () {
        ...
        if (oldState == "offline") {
            ...
            if (NetworkUpCounter > 1) {
                ...
                urlExists('https://mobilepricing-pilot.mohawkind.com');
